  ...
  return (
    <div className="interns-section">
      ...
      {editInternFormData && (
        <div className="intern-form">
          <h2>Edit Intern</h2>
          <form onSubmit={handleEditInternFormSubmit}>
            <input
              type="text"
              name="name"
              placeholder="Name"
              value={editInternFormData.name}
              onChange={handleEditInternInputChange}
              required
            />
            <input
              type="text"
              name="college"
              placeholder="College"
              value={editInternFormData.college}
              onChange={handleEditInternInputChange}
              required
            />
            <input
              ...
              name="email"
              placeholder="Email"
              value={editInternFormData.email}
              onChange={handleEditInternInputChange}
              required
            />
            <input
            ...
            <input
              ...
              name="contact"
              placeholder="Contact"
              value={editInternFormData.contact}
              onChange={handleEditInternInputChange}
              required
            />
            <input
              ...
              name="remarks"
              placeholder="Remarks"
              value={editInternFormData.remarks}
              onChange={handleEditInternInputChange}
            />
            <select
              name="type"
              value={editInternFormData.type}
              onChange={handleEditInternInputChange}
              required
            >
              <option value="Full-time">Full-time</option>
            ...
            <select
              name="batchId"
              value={editInternFormData.batchId}
              onChange={handleEditInternInputChange}
              required
            >
              <option value="">Select Batch</option>
            ...
            <button type="button" onClick={() => setEditInternFormData(null)}>Cancel</button>
          </form>
        </div>
      )}
    </div>
